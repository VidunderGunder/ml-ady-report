...
According to VG [@BibEntry2018Aug] Robotics and AI offers radical improvements in productivity and safety, but the market is slow to adopt new technology. Initial investments for early adopters are expensive and high-risk.
...
Both the AI and robotics market are in rapid growth, and the technologies are being used in most if not all industries in one form or another; [cars can self-drive](https://www.tesla.com/autopilot)(@BibEntry2021Jan), [trading is done with bots using neural networks](https://github.com/microsoft/qlib)(@microsoft2021Jan) and manufacturing is automated ([even with custom designs](https://blog.robotiq.com/7-things-you-need-to-know-about-mass-customization-with-robots)(@Owen-Hill2021Jan)).
