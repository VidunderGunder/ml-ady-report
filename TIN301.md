...
Most robotics firms develop expensive and custom-made robots entirely from scratch, and as a result adoption of the technology suffers. In a recent article commenting the main challenges in robotics [@RobotChallenges2020Mar], it is stated that the main challenge in combining AI and robotics is often the digital brain that operates it. Most tasks already have suitable machinery, all the they need is the autonomy. That's why MLAdy exists - to offer a quick, cheap and accessible way to start using AI and robotics for safer and more effective operation, by focusing on what matters.
...
## Problem Statement
Operations utilizing vehicles, machinery and physical labor are resource-intensive and present serious health risks. According to the Norwegian Labor Inspection Authority [@UlykkerOverjord2021Jan] 50 % of all work related deaths involved vehicles.
...
Both the AI and robotics market are in rapid growth, and the technologies are being used in most if not all industries in one form or another; [cars can self-drive](https://www.tesla.com/autopilot) [@Tesla2021Jan], [trading is done with bots using neural networks](https://github.com/microsoft/qlib) [@Microsoft2021Jan] and manufacturing is automated ([even with custom designs](https://blog.robotiq.com/7-things-you-need-to-know-about-mass-customization-with-robots) [@Owen-Hill2019Oct]).

Global valuations of AI and robotics:
- Artificial intelligence  
  [USD 39.9 billion in 2019  
  USD 733.7 billion in 2027](https://www.grandviewresearch.com/industry-analysis/artificial-intelligence-ai-market) [@AIMarketSizeReport2021Jan2]
- Robotics  
  [USD 76.6 billion in 2020  
  USD 176.8 by 2025](https://www.marketsandmarkets.com/robotics-market-research-112.html) [@RoboticsReport2021Jan]
- Self‑driving cars and trucks  
  [Expected compound annual growth rate (CAGR) of 63.1% from 2021 to 2030](https://www.grandviewresearch.com/industry-analysis/driverless-cars-market) [@AutonomyReport2021Jan10]

Global valuations of some applicable industries:

- Construction  
  [USD 12744.4 billion in 2019  
  USD 15482.0 billion in 2023](https://www.thebusinessresearchcompany.com/report/construction-market) [@ConstructionMarketReport2021Jan12]
- Oil and gas  
  [USD 3.3 trillion in 2019](https://www.investopedia.com/ask/answers/030915/what-percentage-global-economy-comprised-oil-gas-drilling-sector.asp) [@OilGasMArketSize2021Jan11]
  
- Renewable energy  
  [USD 928.0 billion in 2017  
  USD 1512.3 billion by 2025](https://www.alliedmarketresearch.com/renewable-energy-market#:~:text=The%20global%20renewable%20energy%20market,6.1%25%20from%202018%20to%202025.) [@RenewableMarketResearch2021Jan3]
- Contract cleaning services  
  [USD 292.6 billion in 2019  
  USD 468.2 billion in 2027](https://www.grandviewresearch.com/industry-analysis/contract-cleaning-services-market) [@CleaningMarketReport2021Jan8]
- Material handling equipment telematics (storage and logistics)  
  [USD 4274.1 million in 2020  
  USD 7572.2million in 2025](https://www.grandviewresearch.com/industry-analysis/material-handling-equipment-telematics-market) [@MaterialHandlingReport2019Jan]

### Competition and similar offerings


There are multiple big actors working on robotics [@26RobotCompanies2021Jan]. A few examples that overlap in market segments with MLAdy are listed below:
...
Most if not all have started to adopt modern AI [@AIRobotics2021Jan].

Similar or relevant robotic and AI software platforms and frameworks:
...
Some competitors offering retrofit systems:

- [Apollo](https://apollo.auto/index.html) [@ApolloHomepage]  
  Offers an open platform for retrofitting transportation vehicles and fitted vehicles (no retrofit). Similar to MLAdy, even [using Unity as a simulation environment (currently in beta)](https://apollo.auto/gamesim.html) [@ApolloSim], but aimed at a different market segment (transportation) and training approach (mainly based on specific vehicles, not an abstraction). Apollo currently has a wider scope than MLAdy, with better infrastructure integration, and may be an inspiration for MLAdy's pathway. Apollo faces higher needs for security, as they operate on public roads, so a a more precise and specific approach is more suited.
- [Built Robotics](http://www.builtrobotics.com/) [@BuiltRobotics2021Jan5]  
  Similar principles to MLAdy, but offering entire retrofitted vehicles, not a retrofit as a service. Also offers training to engineers.
- [Perrone Robotics](https://www.perronerobotics.com/) [@PerroneRoboticsHomepage2021Jan7]  
...
**Compared to other frameworks:** The closest available alternatives to MLAdy's proposed framework may be [ROS](https://www.ros.org/) [@ROSHomepage2021Jan9] and [PyRobot](https://pyrobot.org/) [@PyRobotHomepage2020Oct]. These are widely used frameworks for making software relating to robots. MLAdy's framework will offer a more opinionated approach, prioritizing retrofitting, intuition and easy-of-use. Parts of both frameworks may simplify some aspects of development, and may be adopted by MLAdy down the line.
...
**Openness (maybe):** MLAdy might offer parts of its resources to the community down the line, like Facebook's [PyTorch](https://pytorch.org/) [@PyTorchHomepage2021Jan14], [React](https://reactjs.org/) [@ReactHomepage2021Jan16] and [PyRobot](https://pyrobot.org/) [@PyRobotHomepage2020Oct], Tesla's [batteries](https://www.tesla.com/blog/all-our-patent-are-belong-you) [@TesleOpenBatteries2019Jul] and Google's [TensorFlow](https://www.tensorflow.org/) [@TensorFlowHomepage2021Jan15]] and [gRPC](https://opensource.google/projects/grpc) [@GRPC2021Jan17], as feedback from the open source community could improve the framework. This decision will be guided by a decision analysis, to make sure the move will strengthen MLAdy's competitive advantage, and will not happen until MLAdy has a healthy revenue stream.
...
**Autonomy by vehicle manufacturers**: Some manufacturers have begun introducing autonomy in newer vehicles, such as Caterpillar [@CATAutonomy2021Jan] and Tesla [@Tesla2021Jan]. MLAdy can work on market segments slow to adopt change or retrofit old vehicles to reduce waste, but these are likely fading opportunities. A more sustainable approach as the retrofit market closes, may be developing technology in cooperation with the manufacturers.
...
Environmental challenges is as relevant as ever [@EnvironmentConcerns2020Sep], and garbage is piling up. Hence, MLAdy has decided that the beginning stages of the project will consist of a deployment of a fleet of budget RC vehicles to collect garbage at the Norwegian University of Life Sciences (NMBU) and surrounding areas.
...
Reality will be more complex than the randomized and abstracted simulation, so the main obstacle is to bridge the simulation-to-reality gap with abstracted vehicle training, and reduce additional training/calibration required in the real world to a minimum. When the simulation-to-reality pipeline is completed, real world transfer training should preferably be accomplished within a few hours on a single vehicle.
...
- [Smart and cloud-connected water fountains](https://www.sildr.no/) [@SildrHomepage2021Jan18]
...
[**Investopedia** defines artificial intelligence as follows](https://www.investopedia.com/terms/a/artificial-intelligence-ai.asp#:~:text=Artificial%20intelligence%20(AI)%20refers%20to,as%20learning%20and%20problem%2Dsolving.) [@AIDefinition2021Jan19]:
...
[**TechTarget**'s definition of machine learning](https://searchenterpriseai.techtarget.com/definition/machine-learning-ML#:~:text=Machine%20learning%20(ML)%20is%20a,to%20predict%20new%20output%20values.) [@BurnsMLDefinition2020Jun]:
...
[**Britannica**'s definition](https://www.britannica.com/technology/robotics) [@RoboticsDefinition2021Jan20]:

> Design, construction, and use of machines (robots) to perform tasks done traditionally by human beings.

**Scalability**

[According to **Investopedia**](https://www.investopedia.com/terms/s/scalability.asp) [@Scalability2021Jan21]:
...
See Google's article, [Closing the Simulation-to-Reality Gap for Deep Robotic Learning](https://ai.googleblog.com/2017/10/closing-simulation-to-reality-gap-for.html) [@SimToRealGoogleBlog2021Jan] for deeper insight.

**Up-to-date papers and code**

To keep up with and utilize the rapid development in the field of AI, computer vision and robotics, MLAdy is daily updating methods based on the newest available research and implementations. The two main hubs used are [PapersWithCode](https://paperswithcode.com/) [@PapersWithCodeHomepage2021Jan23] and [GitHub](https://github.com/) [@GitHubHomepage2021Jan24].
...
As shown in experiments done by scientists at Google  [@SimToRealGoogleBlog2021Jan] simulation can boost reinforcement learning drastically, as it quickly generates models suitable for transfer learning in the real world and eliminates friction related to hardware and environment in the initial stages.
...
- Alternative 1  
  ...
  - Unity (Real-time development platform and game engine)
    - ML Agents (Intuitive tool for reinforcement learning)  
      _Uses PyTorch [@PyTorchUnity2021Jan] and ONNX [@ONNX2021Jan] under the hood, which enables wide compatibility. Offers an intuitive simplified introduction to new users, before diving into more advanced AI development._
...
- Perception loop
  ...
  - Depth estimation  
    _As new papers on depth estimation are coming out frequently, MLAdy uses the fastest available pretrained model with a usable error score (preferably with an open license for commercial use). [AdaBins](https://github.com/shariqfarooq123/AdaBins) [@AdaBinsGitHubJan] is currently being tested, with promising results. The final model will likely be custom trained with a heavily reduced resolution, as speed is prioritized. Deducing depth with remembered depth map and other detection techniques will be attempted to speed up perception further. The current processing time without optimizations is 1-2 seconds._
  ...
  - Locate trash
    - Object detection  
      _MLAdy has trained a custom trash detector with a processing time as low as 2ms, depending on hardware. Trained with the open [Trash Annotations in Context](http://tacodataset.org/) [@TACOGitHub2021Jan] on [YOLOv5](https://github.com/ultralytics/yolov5) [@YOLOv5GitHub2021Jan] with cloud computing. The pipeline supports additional datasets, should precision requirements increase or recycling be introduced._
...
Currently, all code and resources are hosted on GitHub, with read-access to everyone. [This implies all rights reserved by default](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/licensing-a-repository#choosing-the-right-license) [@GitHubLicense2021Jan25] and allows for easy sharing as the project is starting up. Key pieces with competitive value will eventually be closed off, to protect MLAdy from competitors. This will include (but is not limited to):
...
By using an abstract perception of the world with the mental model to train agents, all personal information can be filtered out. This enables the algorithms to respect [principles proposed by the GDPR](https://gdpr.eu/article-5-how-to-process-personal-data/) [@GDPR2018Nov], removing any sensitive information.
...
_*Note: [GNU GPLv3 licenses requires work that distributes the original or modified binaries to also be open source](https://www.gnu.org/licenses/gpl-3.0.en.html) [@GNU2021Jan26]. This means that the modules made with these licenses must be open to customers, but only if the binaries are shared._
...
**Unity** (Paid)  
[Unity licenses](https://store.unity.com/compare-plans) [@UnityTechnologies2021Jan] are based on revenue and funding.
...
**Blender** (Free)  
[GNU GPLv3-license](https://www.blender.org/about/license/) [@BlenderFoundation2021Jan]

**Visual Studio** _Not to be confused with Visual Studio Code_ (Free/Paid)  
Microsoft allows commercial use of Visual Studio for individuals, but organizations require a paid subscription, according to their [license](https://visualstudio.microsoft.com/license-terms/mlt553321/) [@VSLicense2021Jan].

Some team members use Visual Studio intermittently at the time of writing, but the software is being phased out and replaced by Visual Studio Code.

**VSCode or Visual Studio Code** _Not to be confused with Visual Studio_ (Free)  
Microsoft allows commercial use of Visual Studio Code, according to their [license](https://code.visualstudio.com/license) [@VSCodeLicense2021Jan].

**PyTorch** (Free)  
[PyTorch BSD-license](https://github.com/pytorch/pytorch/blob/master/LICENSE) [@PytorchLicense2021Jan]

**TensorFlow** (Free)  
[TensorFlow Apache 2.0-license](https://github.com/tensorflow/tensorflow/blob/master/LICENSE) [@TFLicense2021Jan]

**YOLOv5** (Free)  
[YOLOv5 GNU GPLv3-license](https://github.com/ultralytics/yolov5/blob/master/LICENSE) [@YOLOv5License2021Jan]

**TACO** (Free)  
[TACO MIT-license](https://github.com/pedropro/TACO/blob/master/LICENSE) [@TACOLicense2021Jan]

**AdaBins** (Free)  
[AdaBins GNU GPLv3-license](https://github.com/shariqfarooq123/AdaBins/blob/main/LICENSE) [@AdaBinsLicense1232021Jan]

**GitHub** (Free)  
GitHub offers a generous [free tier](https://github.com/pricing) for teams and organizations [@GithubPricing2021Jan].

## References <!-- Automatically added on export -->

_Note: Homepages and general links are added mainly for convenience, so readers of printed copies has access to the material._